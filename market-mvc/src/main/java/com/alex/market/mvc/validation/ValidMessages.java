package com.alex.market.mvc.validation;
...
public interface ValidMessages {
    ...
    String FILE_EMPTY = "The file must not be empty";
    String FILE_TOO_BIG = "The file must be less";
    String FILE_NOT_IMAGE = "The file must be image";
}
